...
export default function RankingsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="mt-10 rounded-xl p-6 text-center" style={{ backgroundColor: '#002147' }}>
        <h3 className="text-white font-bold text-lg">Know a player who should be ranked?</h3>
        <p className="text-gray-400 text-sm mt-1 mb-4">Submit their info and film link — we review every submission.</p>
        <a href="/submit" className="inline-block px-6 py-2.5 rounded-lg font-bold text-sm transition-all hover:scale-105" style={{ backgroundColor: '#FFD700', color: '#002147' }}>
          Submit a Player
        </a>
      </div>
    </div>
